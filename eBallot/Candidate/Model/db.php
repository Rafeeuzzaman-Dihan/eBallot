...
function CloseCon($conn)
 ...
 //CHECKING Candidate Login
 function CheckCandidateLogin($conn,$table,$uname,$pass)
 {
...
function CloseConEC($connEC)
 ...
 $connEC -> close();
   ...
   function CheckCandidateP($conn,$table,$uname)
   {
...
//UPDATING CANDIDATE DATA
function updateCandidatePData($conn, $tablename, $uname, $pass)
{
    $sqlstr = "UPDATE $tablename SET uname='$uname', pass='$pass' WHERE uname='$uname'";
    if($conn->query($sqlstr))
    {
